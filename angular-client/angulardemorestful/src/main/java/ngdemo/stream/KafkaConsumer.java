...
public class KafkaConsumer {
  ...
  public static void start(final String[] args) throws Exception {
    ...
    final KStream<String, String> textLines = builder.stream(stringSerde, stringSerde, "wikipedia-raw");
    ...
    wordCounts.to(stringSerde, longSerde, "wikipedia-parsed");
